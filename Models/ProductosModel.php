<?php
    class ProductosModel extends Query{
        ...
        public function getProductos(){
            $sql = " SELECT p.*, c.id AS id_categoria, c.nombre AS categoria, m.id AS id_medida, m.nombre AS medida FROM productos p INNER JOIN medidas m ON p.id_medida = m.id INNER JOIN categorias c ON p.id_categoria = c.id ";
            $data = $this->selectAll($sql);
            return $data;
        }
